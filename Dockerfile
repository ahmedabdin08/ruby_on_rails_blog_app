...
# Copy SSL certificates early
#COPY ssl/server.key /rails/ssl/server.key
#COPY ssl/server.crt /rails/ssl/server.crt

# Rails app lives here
WORKDIR /rails

# Install base packages and other dependencies needed for your application
RUN apt-get update -qq && \
    apt-get install --no-install-recommends -y build-essential git libpq-dev pkg-config --fix-missing && \
